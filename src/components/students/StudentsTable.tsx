                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-border/50 bg-slate-50/50 dark:bg-slate-900/20">
                                <th className="h-10 px-5 text-left align-middle text-[10px] font-bold text-muted-foreground uppercase tracking-wider whitespace-nowrap">
                                    Student
                                </th>
                                <th className="h-10 px-5 text-left align-middle text-[10px] font-bold text-muted-foreground uppercase tracking-wider whitespace-nowrap">
                                    Cohort
                                    ...
                                    >
                                        <td className="px-5 py-4 align-middle">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col min-w-0">
                                                    ...
                                                    <span className="text-[11px] text-muted-foreground leading-none mt-0.5 truncate max-w-[150px]">
                                                        {student.email}
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-5 py-4 align-middle text-muted-foreground text-[12px] whitespace-nowrap">
                                            {student.cohortName}
                                        </td>
                                        ...
                                        <td className="px-5 py-4 align-middle text-right whitespace-nowrap">
                                            <button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    // Could open specific menu action here
                                                }}
                                            >
