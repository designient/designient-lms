...
export function Drawer({
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-end">
            ...
            />
            <div
                className={`relative z-50 flex h-full w-full flex-col border-l border-border/50 bg-card shadow-xl transition-transform duration-200 ease-out ${sizeClasses[size]} ${className}`}
                role="dialog"
                aria-modal="true"
            >
