        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-50 w-full max-w-md mx-4 bg-background rounded-xl shadow-xl border border-border/60 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div
                        className={`p-4 rounded-lg border ${isAtCapacity
                    ...
                    >
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                <div
                                    className={`h-10 w-10 rounded-lg flex items-center justify-center ${isAtCapacity
                                            ? 'bg-red-100'
                                            : isNearCapacity
                                                ? 'bg-amber-100'
                                                : 'bg-primary/10'
                                ...
                                >
                                    <Users
                                        className={`h-5 w-5 ${isAtCapacity
                                                ? 'text-red-600'
                                                : isNearCapacity
                                                    ? 'text-amber-600'
                                                    : 'text-primary'
                            ...
                            <div className="text-right">
                                <span
                                    className={`text-2xl font-bold ${isAtCapacity
                                            ? 'text-red-600'
                                            : isNearCapacity
                                                ? 'text-amber-600'
                                                : 'text-foreground'
                        ...
                        <div className="h-2 bg-muted rounded-full overflow-hidden">
                            <div
                                className={`h-full rounded-full transition-all ${isAtCapacity
                                        ? 'bg-red-500'
                                        : isNearCapacity
                                            ? 'bg-amber-500'
                                            : 'bg-primary'
                            ...
                            {eligibleMentors.map((mentor) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div
                                                className={`h-9 w-9 rounded-lg flex items-center justify-center text-sm font-semibold ${isSelected
                                                        ? 'bg-primary/10 text-primary'
                                                        : 'bg-gradient-to-br from-emerald-500/20 to-emerald-500/10 text-emerald-700'
                                                    }`}
                                            >
