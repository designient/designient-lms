...
import { Bell, Loader2, Lock, Monitor, Moon, Save, Sun } from 'lucide-react';
...
interface MentorSettingsProfile {
...
export default function MentorSettingsPage() {
    ...
    useEffect(() => {
        async function load() {
            try {
                const profile = await apiClient.get<MentorSettingsProfile>('/api/v1/me/profile');
    ...
    const handleSaveNotifications = async () => {
        ...
        try {
            await apiClient.patch('/api/v1/me/profile', { emailNotifications, pushNotifications });
