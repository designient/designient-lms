                        ...
                        {courses.map((course) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="group"
                                >
                                    <div className="rounded-xl border border-border/50 bg-card hover:border-primary/30 hover:shadow-sm transition-all h-full flex flex-col overflow-hidden">
                                        <div className="h-32 bg-gradient-to-br from-muted/50 to-muted/20 flex items-center justify-center text-4xl">
                                            {config.emoji}
                                        </div>
                                        <div className="p-4 flex-1 flex flex-col">
                                            <span
                                                className={`text-[10px] font-medium uppercase tracking-wider ${config.color} px-2 py-0.5 rounded self-start mb-2`}
                                            >
                                                {course.level}
                                            </span>
