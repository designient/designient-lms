          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-9 ${touched.price && errors.price ? 'border-destructive focus:border-destructive' : ''}`} />
          ...
          {mentorOptions.map((mentor) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-all border ${isSelected ? 'bg-primary/5 border-primary/30 text-foreground' : 'bg-transparent border-border/60 text-muted-foreground hover:bg-muted/40 hover:border-border'}`}>

                <div className="flex items-center gap-3">
                  <div
                    className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-semibold ${isSelected ? 'bg-primary/10 text-primary' : 'bg-muted text-muted-foreground'}`}>
      ...
      <DrawerSection title="Description">
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <span
              className={`text-xs ${descriptionLength > maxDescriptionLength ? 'text-destructive' : 'text-muted-foreground'}`}>
