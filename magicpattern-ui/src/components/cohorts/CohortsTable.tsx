                    ...
                    <td className="px-5 py-4 align-middle">
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="h-1.5 w-24 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
                          <div
                        className={`h-full rounded-full ${cohort.studentCount >= cohort.capacity ? 'bg-amber-500' : 'bg-emerald-500'}`}
                        style={{
                          width: `${Math.min(cohort.studentCount / cohort.capacity * 100, 100)}%`
                        }} />
