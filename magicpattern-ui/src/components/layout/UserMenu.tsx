...
export function UserMenu({ open, onClose, onNavigate }: UserMenuProps) {
  ...
  return (
    <>
      ...
      <div className="absolute right-0 top-full mt-1.5 w-56 rounded-lg border border-border/50 bg-card shadow-xl z-40 animate-in fade-in slide-in-from-top-2 duration-200">
        {/* User Info */}
        ...
        <div className="p-2.5 border-b border-border/50">
          ...
          <div className="flex gap-0.5 p-0.5 bg-muted/50 rounded-md">
            ...
            <button
              ...
              className={`
                  flex-1 flex items-center justify-center gap-1 px-1.5 py-1 rounded text-[10px] font-medium transition-all
                  ${theme === option.value ? 'bg-card text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}
                `}>
