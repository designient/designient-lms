...
import {
  MentorFilters,
  MentorStatus } from
'../components/mentors/MentorFilters';
import {
  MentorsTable,
  Mentor,
  AssignedCohort } from
'../components/mentors/MentorsTable';
import { MentorDrawer } from '../components/mentors/MentorDrawer';
import {
  MentorForm,
  MentorFormData,
  MentorFormFooter } from
'../components/mentors/MentorForm';
...
export function MentorsPage({
  ...
  // Handle initial mentor selection from search
  useEffect(() => {
    if (initialMentorId) {
      const mentor = mentors.find((m) => m.id === initialMentorId);
      if (mentor) {
